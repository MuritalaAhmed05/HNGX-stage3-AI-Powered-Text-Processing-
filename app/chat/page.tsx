                ...
                <div className="flex justify-between gap-4 items-center">
                  {msg.detectedLang && (
                    <span className="text-xs text-blue-600 block mt-1 font-medium">
                      Language: {languageMap[msg.detectedLang] || msg.detectedLang}
                    </span>
                  )}
            ...
            <div className="flex justify-end items-center gap-2">
              ...
              >
                ...
                {Object.entries(languageMap).map(([code, name]) => (
                  <option key={code} value={code} className="bg-white dark:bg-[#060606] hover:bg-gray-100 dark:hover:bg-[#121212] text-black dark:text-white max-w-[200px]">
                    {name}
                  </option>
                ))}
              </select>
